...
- **Locate, then reconcile by hand.** Prices live in body prose (What they offer / How it works), not frontmatter: `rg -n '\$[0-9]|/mo|per month' store/<slug>/profile.md`. Units fragment even within a cohort (first-month, membership-stacked, billing cadence) — normalize manually.
