...
- [`learning/`](learning/README.md) - the cross-run learning loop: agents log observations during runs; the `/learning-review` pass (target `agentic-build`) consolidates them into proposed lessons. Design: [`_design/2026-06-23-learning-system-proposal.md`](_design/2026-06-23-learning-system-proposal.md).
