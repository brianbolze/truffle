...
warm_from: store/ro-co/captures/2026-06-01/weight_loss.md (firecrawl scrape 2026-06-01, basic proxy)
capture: warm (reused from store)
topic: Weight-loss hub — the GLP-1 SKU roster (Wegovy pill, Zepbound KwikPen, Foundayo pill, Wegovy pen, Zepbound pen, Ozempic) each tagged "Cash-pay only" or "Insurance or cash-pay", plus Ro Body membership FAQ pricing ($39 first mo / $74 annual / $149 monthly). Per-SKU $ prices live on /weight-loss/pricing/ (fetched separately).
-->
...
- _See if you qualify_ for Zepbound, Wegovy pill, or other GLP-1s

- _Lose 20%_ body weight on average with Zepbound\*

- _Learn what your insurance covers_ to help with cost


[Start your journey](https://start.ro.co/fdalgd/?referrer=https%3A%2F%2Fwww.google.com%2F&referring_domain=www.google.com)

[Start with a free insurance check](https://ro.co/weight-loss/glp1-insurance-checker/signup/)
...
**Safety info:** GLP-1 medications may have serious side effects, including possible thyroid tumors. **Do not use if you or your family have a history of a type of thyroid cancer called MTC or MEN 2.** See more serious warnings & safety info [here](https://ro.co/weight-loss/#safety).
...
[Get started](https://start.ro.co/fdalgd/?referrer=https%3A%2F%2Fwww.google.com%2F&referring_domain=www.google.com)

- [Meds](https://ro.co/weight-loss/#medications)
- [How it works](https://ro.co/weight-loss/#how-it-works)
- [Pricing](https://ro.co/weight-loss/#pricing)
- [Safety](https://ro.co/weight-loss/#safety)
...
If paying cash, your medication ships right to your door and you can take your first dose in less than a week.

If using insurance, your medication can be picked up at your pharmacy.

### 5\. Get support to stay on track

Keep making progress with regular check-ins, expert guidance, and access to your care team 24/7.

Ongoing care and support is there for you when you need it—whether it’s a quick chat with your provider or routine check-ins, we’re with you every step of the way.

## Healthier on Ro

Our members on GLP-1s are losing weight, but that's not the full story. Learn more about their health wins beyond the scale.

[Learn more](https://ro.co/weight-loss/serena/)
...
"Just like I always have, I’m making informed decisions for my health and my body. I’m using Ro to manage my weight."
...
“I did my research, but nothing came close to what Ro offered.”

Greg

Ro member

“It feels amazing to have a supportive team that actually listens to me.”

DeAnna

Ro member

“I’m not fighting against my own body anymore. It’s been consistent, real results.”

Mitchell

Ro member

Average weight loss in 1 year is 11-20% (vs ~2-3% with diet and exercise alone). Based on studies in non-diabetics with obesity, or overweight plus a weight-related condition, with diet and exercise.

\*Based on survey results of 1,243 Ro members taking GLP-1 medication for at least 7 weeks, paired with diet and exercise.

## What's included in the Ro Body membership?
...
- A full suite of FDA-approved GLP-1s, including Wegovy and Zepbound

- Insurance or cash-pay

- Prepay & Save unlocks the lowest Wegovy prices


[Learn more about pricing](https://ro.co/weight-loss/pricing/)
...
Learn more about safety information, including serious warnings: [ro.co/safety/](https://ro.co/safety-info/glp1/)
...
Dr. Steve Silvestro, MD, DABOM

Clinical Content & Education at Ro, Board Certified in Obesity Medicine

[Learn more](https://ro.co/weight-loss/articles/)
...
[Important safety information \- Read more](https://ro.co/weight-loss/#glp1-isi-jump)