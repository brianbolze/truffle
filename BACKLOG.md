...
- **Traction module / verb** `[idea]` `[xl]` `[parked]` `[@brian]`
  ...
  **UPDATE:** The `log.md` approach from Google's [Open Knowledge Format](https://cloud.google.com/blog/products/data-analytics/how-the-open-knowledge-format-can-improve-data-sharing/) could be viable approach here - which might change our mind about the shape/location of this. Worth doing another design spike on this soon.
