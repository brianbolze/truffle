...
Date: 2026-06-14 · Status: solution design (Proposal). Companion to the [traction FRAME](2026-06-14-traction-frame.md); answers its Open Questions #1–#4 + #6. Propose, not build — no SCHEMA edits, no tool code this session.
