...
- **Run a capture** (profile/research a company) → use the `/research-company` skill. It's self-contained — its own capture playbook ([`firecrawl-capture.md`](skills/research-company/firecrawl-capture.md)) ships beside it, plus the store contract ([`SCHEMA.md`](SCHEMA.md)/[`TAXONOMIES.md`](TAXONOMIES.md)) — you need nothing else here.
