...
- **Consume the store** (query captured research) → use the `/query-companies` skill. It is the read-only router/guardrail; recipes stay in [`QUERYING.md`](QUERYING.md), then `store/<domain>/`. The dossier *is* the product.
