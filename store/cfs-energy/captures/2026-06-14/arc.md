...
CFS will independently finance, build, own, and operate [the first ARC power plant](https://cfs.energy/chesterfield/overview) at the Fall Line Fusion Power Station in Chesterfield County, near Richmond, Virginia — an area with a growing population, economy, and demand for energy. We expect this ARC project will create hundreds of jobs to build and operate the power plant.

[CFS has also established a strategic partnership with Google](https://blog.cfs.energy/google-deal-helps-propel-cfs-fusion-energy-onto-the-grid/), who has agreed to purchase half the first plant’s power and further their investment in the company. This relationship will prove valuable for not only the first ARC, but future ARC power plants as we continue on our path to commercialize fusion energy.
