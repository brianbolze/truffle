...
- **Dermatology (Rx topicals) & peptides:** prescription skincare (e.g. **Soothing rosacea cream — $85**, legacy PDP) and a peptide library (dihexa, methylene blue, GHK-Cu, TB-4) — the legacy `/treatments/` catalog, now largely accessed through the concierge practice. Skincare `[published]` (legacy); peptides `[on-request]`.
- **Supplements (shop.hevahealth.com):** ~14 Shopify SKUs, **$35–$169** — curated "Vitamin Stacks" (Male/Female Vitality Complex, Lifespan Formula, NMN, GLP-1 Activator, Cognition Complex), powders, creams, and merch. Repackaged third-party formulations "Powered by Vitaboom." `[published]`
