...
[See packages](https://www.cloudflare.com/plans/enterprise/)
...
| Component | Free | Paid |
| --- | --- | --- |
| Requests | 100,000 requests / day | $0.30 / million requests |
| CPU Time | 13,000 GB-s / day | $0.02 / million CPU ms |
...
| Component | Free | Paid |
| --- | --- | --- |
| Ingestion | 100,000 / day | TBD (free during beta) |
| Delivery to R2 | 10,000 / day | TBD (free during beta) |
...
Starting at $5/mo [Activate](https://www.cloudflare.com/products/argo-smart-routing/)
...
Starting at $5/mo [Activate](https://www.cloudflare.com/products/cloudflare-stream/)
...
Usage-based [Activate](https://www.cloudflare.com/products/cache-reserve/)
...
first 10 GB free [Activate](https://www.cloudflare.com/products/log-explorer/)
...
$0.099/1k requests [Activate](https://developers.cloudflare.com/client-side-security/?_gl=1*8j935e*_gcl_au*NDQyNDc1NDY4LjE3Nzg2MTc4MDU.*_ga*NWY2ZmU5NTQtMjFkMi00NmEyLTg5OTMtMWU2ZjRmOGU3ODZi*_ga_SQCRB0TXZW*czE3Nzg2ODMzODgkbzIkZzAkdDE3Nzg2ODMzODgkajYwJGwwJGgw)

#### Cloudflare Registrar

At-cost domain registration with no markup pricing.

Starting at $7.85 [Register](https://www.cloudflare.com/products/registrar/)

#### Workers

Deploy serverless code in JavaScript, Rust, C, and C++ at the edge.

Free to try [Get started](https://www.cloudflare.com/developer-platform/workers/)

## Cloudflare powers  1 in 5 sites on the Internet
...
> ### “ForShopify,therealchallengeisnotabouthowmanydifferentpiecesofcomplextechnologywecanusebuttheopposite.Cloudflarehelpsusfindasimplewaytoachievesomethingverycomplexthatwecanscaleandmaintain.”
...
[Browser Run  Automated browsers](https://www.cloudflare.com/products/browser-rendering/)
...
[Data Platform  Ingest, Catalog & Query](https://www.cloudflare.com/products/data-platform/)
...
[Access  Safe access to private applications](https://www.cloudflare.com/products/access/)

[Data Loss Prevention  Protect sensitive data](https://www.cloudflare.com/products/dlp/)

[Secure Web Gateway  DNS filtering & Secure Browsing](https://www.cloudflare.com/products/secure-web-gateway/)

[WAN  Cloud-delivered enterprise networking](https://www.cloudflare.com/products/wan/)

[Mesh  Agents private network](https://www.cloudflare.com/products/mesh/)
...
[Page Shield  Client-Side Protection](https://www.cloudflare.com/products/page-shield/)
