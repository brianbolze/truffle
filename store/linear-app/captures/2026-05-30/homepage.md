<!-- capture: linear.app homepage | sourceURL=https://linear.app | status=200 | captured=2026-05-30 | method=firecrawl/v2 scrape -->
...
Cursor moved from Todo toIn Progress· just now
...
1.I need to understand why iOS launch is blocking on vehicle\_state sync
